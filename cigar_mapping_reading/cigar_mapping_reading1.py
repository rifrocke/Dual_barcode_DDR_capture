...
# --- Argument Parsing ---
parser = argparse.ArgumentParser(description='Process CIGAR strings from .csv files to extract mutation information.')

parser.add_argument("-i", dest="input_folder", type=str, required=True,
                    help="Path to the input folder containing CSV files with a 'Cigar' column.")
